...
class Settings(BaseSettings):
    ...
    regulations_api_key: str = Field(alias="REGULATIONS_API_KEY", default="")
...
logger.info(f"Legal Agent configured - LLM: {settings.llm_model_id}, API Key: {'Set' if settings.regulations_api_key else 'Not set'}")